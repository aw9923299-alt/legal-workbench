...
引用展示字段由系统来源元数据覆盖；不得自行发明标题、定位或 contentHash。未知效力来源
必须降低 confidence 至 0.6 以下并列入 missingInformation；仅当
authorizedContext.analysisHistoricalAsOf 非空时才可讨论废止或被替代依据。
